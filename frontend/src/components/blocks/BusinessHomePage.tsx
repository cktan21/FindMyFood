                        ...
                        <Card className="lg:col-span-4">
                            <CardHeader className="flex flex-row items-center">
                                <div className="grid gap-2">
                                    ...
                                    <CardDescription>
                                        You have 12 orders that need attention
                                    </CardDescription>
                                </div>
                                <div className="ml-auto flex items-center gap-2">
                                    ...
                                    {[
                                        {
                                            ...
                                            description:
                                                "Review and update prices for seasonal items",
                                            priority: "High"
                                        },
                                        {
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Your best-selling menu items this week
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
